...
static inline bool leads_group (CHAR_DATA * ch)
{
  CHAR_DATA *gch;
...
static inline int adjust_hitroll (CHAR_DATA * ch)
{
...
static inline int adjust_damroll (CHAR_DATA * ch)
{
...
static inline int get_hitroll2 (CHAR_DATA * ch)
{
  int hroll = 0;
