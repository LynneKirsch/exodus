...
void do_flag (CHAR_DATA * ch, char *argument)
{
  ...
  CHAR_DATA *victim;
  long *flag, old = 0, newflag = 0, marked = 0, pos;
  char type;
  ...
  if (arg1[0] == '\0')
    {
      ...
      send_to_char
	("  mob  flags: act,aff,off,imm,res,vuln,form,part, act2\n\r", ch);
  ...
  if (!str_prefix (arg1, "mob") || !str_prefix (arg1, "char"))
      ...
      for (;;)
	{
	  ...
	  if (word[0] == '\0')
	    break;
	  pos = oflag_lookup (word, flag_table);
	  if (pos == 0)
	    {
