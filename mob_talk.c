...
static inline int said_name (char *name, struct talk_list *tlist)
{
...
static inline void free_response_list (struct response_list *rlist)
{
...
static inline void free_talk_list (struct talk_list *tlist)
{
...
static inline int calculate_new_mood (char *string, int old_mood)
{
...
static inline int mood_matches (char *string, int mood_value)
{
  switch (string[0])
    {
    case '<':
